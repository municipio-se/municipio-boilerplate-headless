...
define(
  "WHITESPACE_A11YSTACK_ENABLE_FEEDBACK_MODULE",
  env("WHITESPACE_A11YSTACK_ENABLE_FEEDBACK_MODULE")
);

define("MUNICIPIO_GATSBY_ENABLE_SIMPLIFIED_MOD_POSTS_LAYOUTS", true);
